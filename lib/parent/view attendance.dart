...
class ViewStudent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewstudentAttendanceParent(title: 'View Attendance'),
    );
  }
}

class ViewstudentAttendanceParent extends StatefulWidget {
  const ViewstudentAttendanceParent({super.key, required this.title});

  final String title;

  @override
  State<ViewstudentAttendanceParent> createState() => _ViewstudentAttendanceParentState();
}

class _ViewstudentAttendanceParentState extends State<ViewstudentAttendanceParent> {

  _ViewstudentAttendanceParentState(){
    ViewStudent();
  }
  ...
  Future<void> ViewStudent() async {
    ...
    try {
      ...
      String url = '$urls/parent_view_attendance/';

...
import 'package:eagles_123/student/view%20attendance.dart';
import 'package:eagles_123/student/view%20violence.dart';
...
class HomeNew extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const StudentHome(title: 'Home'),
    );
  }
}

class StudentHome extends StatefulWidget {
  const StudentHome({super.key, required this.title});
...
class _StudentHomeState extends State<StudentHome> {
  ...
  void _send_data() async{
    ...
    final urls = Uri.parse('$url/student_view_profile/');
    try {
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => StudentHome(title: 'home'),));
                },
              ),
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => userProfile_new1(title: 'View Profile',),));
                },
              ),
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                 Navigator.push(context, MaterialPageRoute(builder: (context) => ViewStudentAttendance(title: "View Attendance",),));
                },
              ),
             ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => Student_ViolenceReportPages(title: ''),));
                },
              ),
              // ListTile(
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => MyChangePasswordPages(title: "Change Password",),));
                },
              ),
              // ListTile(

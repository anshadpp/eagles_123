...
class MyChangePassword extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyChangePasswordPages(title: 'ChangePassword'),
    );
  }
}

class MyChangePasswordPages extends StatefulWidget {
  const MyChangePasswordPages({super.key, required this.title});

  final String title;

  @override
  State<MyChangePasswordPages> createState() => _MyChangePasswordPagesState();
}

class _MyChangePasswordPagesState extends State<MyChangePasswordPages> {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final urls = Uri.parse('$url/student_change_password/');
                  try {

...
class ViolenceReport extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Student_ViolenceReportPages(title: 'View Violence'),
    );
  }
}

class Student_ViolenceReportPages extends StatefulWidget {
  const Student_ViolenceReportPages({super.key, required this.title});

  final String title;

  @override
  State<Student_ViolenceReportPages> createState() => _Student_ViolenceReportPagesState();
}

class _Student_ViolenceReportPagesState extends State<Student_ViolenceReportPages> {

  _Student_ViolenceReportPagesState(){
    ViolenceReport();
  }
  ...
  Future<void> ViolenceReport() async {
    ...
    try {
      ...
      String url = '$urls/student_view_issue_list/';
